                    ...
                    <form method='post' action="{{ route('owner.shops.update', ['shop' => $shop->id ]) }}" enctype="multipart/form-data">
                        ...
                        <div class="-m-2">
                            <div class="p-2 w-1/2 mx-auto">
                                <div class="relative">
                                  <label for="name" class="leading-7 text-sm text-gray-600">ショップ名 ※必須</label>
                        ...
                        <div class="p-4 w-1/2 mx-auto">
                            <div class="relative flex justify-around">
                                <input type="radio" name="is_selling" value="1" class="ml-12" @if($shop->is_selling === 1){ checked } @endif>販売中
                                <input type="radio" name="is_selling" value="0" class="ml-12" @if($shop->is_selling === 0){ checked } @endif>販売停止中
                            </div>
                        </div>

                          <div class="p-2 w-full flex justify-around mt-4">
                            <div><button type="button" onclick="location.href='{{ route('owner.shops.index') }}'" class="bg-gray-200 border-0 py-2 px-8 focus:outline-none hover:bg-gray-400 rounded text-lg">戻る</button></div>
