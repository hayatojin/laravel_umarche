                        ...
                        <div class="-m-2">
                            ...
                            <div class="p-4 w-1/2 mx-auto">
                                <div class="relative flex justify-around">
                                    <input type="radio" name="type" value="{{ \Constant::PRODUCT_LIST['add'] }}" class="ml-12" checked>追加
                                    <input type="radio" name="type" value="{{ \Constant::PRODUCT_LIST['reduce'] }}" class="ml-12">削減
                                </div>
                            </div>
                            ...
                            <div class="p-4 w-1/2 mx-auto">
                                <div class="relative flex justify-around">
                                    <div><input type="radio" name="is_selling" value="1" class="ml-2" @if($product->is_selling === 1){ checked } @endif>販売中</div>
                                    <div><input type="radio" name="is_selling" value="0" class="ml-2" @if($product->is_selling === 0){ checked } @endif>販売停止中</div>
                                </div>
                            </div>
