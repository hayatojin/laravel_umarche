                ...
                <div class="p-6 bg-white border-b border-gray-200">
                    ...
                    <form method="post" action="{{ route('owner.products.store') }}">
                        ...
                        <div class="-m-2">
                            ...
                            {{-- コントローラーから渡ってくるimagesの変数を、コンポーネントに渡す --}}
                            ...
                            <div class="p-4 w-1/2 mx-auto">
                                <div class="relative flex justify-around">
                                    <input type="radio" name="is_selling" value="1" class="ml-12" checked>販売中
                                    <input type="radio" name="is_selling" value="0" class="ml-12">販売停止中
                                </div>
                            </div>

                          <div class="p-2 w-full flex justify-around mt-4">
                            <div><button type="button" onclick="location.href='{{ route('owner.products.index') }}'" class="bg-gray-200 border-0 py-2 px-8 focus:outline-none hover:bg-gray-400 rounded text-lg">戻る</button></div>
                            <div><button type="submit" class="text-white bg-indigo-500 border-0 py-2 px-8 focus:outline-none hover:bg-indigo-600 rounded text-lg">登録する</button></div>
                          </div>
                        </div>
                    </form>
                </div>
